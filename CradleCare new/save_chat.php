...
include('connection.php');
	...
	$date_today = date("d/m/Y");	
				$sql = "INSERT INTO group_chat(chat_out,from_user_id,to_userid,chat_time,sender_name,chat_date)VALUES('$the_message','$sender_id','$to_id','$chat_time','$sender_name','$date_today')";
